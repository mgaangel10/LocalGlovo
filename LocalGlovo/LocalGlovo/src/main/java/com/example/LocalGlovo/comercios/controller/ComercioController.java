...
public class ComercioController {
    ...
    @Operation(summary = "Listar comercios en googleMaps")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    description = "Se ha listado las categorias",
                    content = {@Content(mediaType = "application/json",
    ...
    @Operation(summary = "Listado de comercios para usuarios")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
    ...
    @Operation(summary = "Listado de comercios para administradores")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    description = "Se ha listado los comercios",
                    content = {@Content(mediaType = "application/json",
    ...
    @Operation(summary = "filtrado de comercios por categroias")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
                    description = "Se ha listado los comercios",
                    content = {@Content(mediaType = "application/json",
    ...
    @Operation(summary = "editar comercio por id")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201",
                    description = "Se ha editado el comercio",
                    content = {@Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = Comercio.class)),
                            examples = {@ExampleObject(
                                    value = """
